...
import { useHomeChatState } from "../../pages/home/hooks/useHomeChatState";
import Header from "./Header";
import AppSidebar from "./Sidebar";
import { Toaster } from "../common/Toaster";

export default function AppLayout() {
  const { user, token, logout, redirectToLogin, isLoading, language, t } =
  ...
  const threadHook = useHomeChatState({ token, userId, t, onUnauthorized });
