 ...
 * - pages/keyword-search/api.js の searchKeyword を使用
 * - Admin 関連リンクを除外
 */
...
import KeywordResultText from "../../features/keyword-search/KeywordResultText";
...
export default function KeywordSearchPage() {
  ...
  useEffect(() => {
    const q = new URLSearchParams(searchParamString).get("q");
    const nextKeyword = q || "";
    setKeyword(nextKeyword);
    if (nextKeyword.trim()) executeSearch(nextKeyword.trim());
                        ...
                        <div className="flex items-start justify-between gap-4">
                          <div className="flex items-start gap-3 text-lg font-semibold text-zinc-900 min-w-0 flex-1">
                            ...
                            <div className="flex-1 min-w-0 leading-relaxed">
                              <KeywordResultText content={question.question_text || t.loading} />
                            </div>
                          </div>
                        ...
                        {visibleAnswerId === question.question_id && (
                          <div className="mt-4 rounded-md bg-blue-50/50 p-4 text-zinc-800">
                            ...
                            <div className="text-base leading-8 whitespace-pre-wrap break-words">
                              <KeywordResultText content={question.answer_text || t.loading} />
                            </div>
                          </div>
                        )}
                      </div>
