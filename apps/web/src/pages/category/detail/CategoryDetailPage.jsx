...
import CategoryAnswerText from "../../../features/category/CategoryAnswerText";
...
import { FlagIcon } from "../../../features/category/QaLanguageFlag";
import {
  IdCard,
  HeartHandshake,
  Stethoscope,
  ...
  useEffect(() => {
    ...
    async function loadCategoryName() {
      try {
        ...
        if (!controller.signal.aborted) setCategoryName(nameText);
      } catch (error) {
                            ...
                            <div className="flex items-start justify-between gap-4">
                              <div className="flex min-w-0 flex-1 items-start gap-3 text-lg font-semibold text-zinc-900">
                                ...
                                <div className="min-w-0 flex-1 leading-relaxed">
                                  <CategoryAnswerText content={question.質問} />
                                </div>
                              </div>
                            ...
                            {visibleAnswerId === question.question_id && (
                              <div className="mt-4 rounded-md bg-blue-50/50 p-4 text-zinc-800">
                                ...
                                <div className="whitespace-pre-wrap break-words text-base leading-8">
                                  <CategoryAnswerText content={question.回答 || t.loading} />
                                </div>
                              </div>
                            )}
                          </div>
